          ...
          : html`
              <div
                class="sidebar-recent-sessions ${
                  state.settings.recentSessionsCollapsed ? "sidebar-recent-sessions--collapsed" : ""
                }"
      ...
      >
        ...
        ${
          state.tab === "config" || isChat
            ...
            : html`<section
                class=${
                  chatHeaderHidden ? "content-header content-header--chat-hidden" : "content-header"
                }
          ...
          state.tab === "workboard"
            ? renderLazyView(lazyWorkboard, (m) => {
                ...
                return m.renderWorkboard({
                  ...
                  pluginEnabled: isPluginEnabledInConfigSnapshot(
                    state.configSnapshot,
                    "workboard",
                    {
                      enabledByDefault: false,
            ...
            ? renderLazyView(lazyAgents, (m) =>
                m.renderAgents({
                  ...
                  onModelFallbacksChange: (agentId, fallbacks) => {
                    ...
                    const { basePath: basePathResult, existing } =
