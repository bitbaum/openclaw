                                  ...
                                  selectedDeliveryMode === "webhook"
                                    ...
                                    : html`
                                        <select
                                          ...
                                          @change=${(e: Event) =>
                                            props.onFormChange({
                                              deliveryChannel: (e.target as HTMLSelectElement)
                                                .value,
                                            })}
                                        >
                                          ${channelOptions.map(
                                  ...
                                  ? html`
                                      <label class="field">
                                        ...
                                        <input
                                          ...
                                          aria-invalid=${
                                            props.fieldErrors.failureAlertAfter ? "true" : "false"
                                          }
                                          aria-describedby=${ifDefined(
                                          ...
                                          @input=${(e: Event) =>
                                            props.onFormChange({
                                              failureAlertAfter: (e.target as HTMLInputElement)
                                                .value,
                                            })}
                                          placeholder="2"
                                        />
                                      ...
                                      <label class="field">
                                        ...
                                        <select
                                          ...
                                          @change=${(e: Event) =>
                                            props.onFormChange({
                                              failureAlertChannel: (e.target as HTMLSelectElement)
                                                .value,
                                            })}
                                        >
                                          ${channelOptions.map(
                                      ...
                                      <label class="field">
                                        ...
                                        <input
                                          ...
                                          @input=${(e: Event) =>
                                            props.onFormChange({
                                              failureAlertAccountId: (e.target as HTMLInputElement)
                                                .value,
                                            })}
